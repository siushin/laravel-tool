...
class Installer
{
    ...
    public static function postInstall(): void
    {
        ...
        if ($version === 'dev-main') {
            echo "\n\033[33m注意：您正在使用 siushin/laravel-tool 的开发版本 (dev-main)\033[0m";
            echo "\n\033[33m生产环境建议使用稳定版本：composer require siushin/laravel-tool:^1.0\033[0m\n\n";
        } elseif (strpos($version, 'dev') !== false) {
            echo "\n\033[33m注意：您正在使用 siushin/laravel-tool 的开发版本 ($version)\033[0m\n\n";
        }
    }
